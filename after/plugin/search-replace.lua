local opts = {}
vim.api.nvim_set_keymap("v", "<leader>rw", "<CMD>SearchReplaceSingleBufferVisualSelection<CR>", opts)
...
vim.api.nvim_set_keymap("n", "<leader>rw", "<CMD>SearchReplaceSingleBufferOpen<CR>", opts)
