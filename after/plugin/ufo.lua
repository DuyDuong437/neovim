...
vim.keymap.set("n", "zp", goNextClosedAndPeek)
vim.keymap.set("n", "zo", goPreviousClosedAndPeek)
vim.keymap.set("n", "zl", ':foldclose<cr>')
vim.keymap.set("n", "zm",  ':foldopen<cr>')
vim.keymap.set("n", "zM", require("ufo").openAllFolds)
vim.keymap.set("n", "zL", require("ufo").closeAllFolds)
